...
description: Learn how MQTT publish/subscribe messaging works and how Apache BifroMQ (Incubating) implements an MQTT broker for multi-tenant IoT messaging.
keywords:
  - MQTT
  - MQTT protocol
  - MQTT broker
...
<Head>
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      description:
        'Learn how MQTT publish/subscribe messaging works and how Apache BifroMQ (Incubating) implements an MQTT broker for multi-tenant IoT messaging.',
